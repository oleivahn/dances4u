...
const HomePage = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="bg-dark relative pt-[120px] pb-[110px] md:pt-[150px] lg:pt-[180px]">
        <div className="container mx-auto">
          <div className="mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-5/12">
              <div className="px-20">
                <h1 className="mb-5 text-4xl font-bold leading-snug text-white sm:text-5xl sm:leading-tight">
                  Landing Template For Startups
                </h1>
                <p className="mb-8 max-w-[480px] text-base text-[#e4e4e4]">
                ...
                <ul className="flex items-center">
                  <li>
                    <a
                      href="/#"
                      className="bg-primary inline-flex items-center justify-center rounded-lg py-4 px-10 text-center text-base font-normal text-white hover:bg-opacity-90"
                    >
                      Get Started
                    </a>
                  </li>
        ...
        <div
          className={`fixed top-0 left-0 z-50 flex h-screen w-full items-center justify-center bg-black bg-opacity-70 ${
        ...
        >
          ...
          <button
            ...
            className="text-body-color absolute top-0 right-0 flex h-20 w-20 cursor-pointer items-center justify-center hover:bg-black"
          >
        ...
        <div className="relative -mx-4 flex items-center justify-between">
          ...
          <div className="flex w-full items-center justify-between px-4">
            <div>
              ...
              <nav
                className={`absolute right-4 z-50 top-full w-full max-w-[250px] rounded-lg bg-white py-5 px-6 shadow lg:static lg:block lg:w-full lg:max-w-full lg:bg-transparent lg:shadow-none ${
                  !open && "hidden"
                } `}
              >
            ...
            <div className="hidden justify-end pr-16 sm:flex lg:pr-0">
              <a
                href="/#"
                className="text-white rounded-lg bg-primary py-3 px-7 text-base font-medium hover:bg-opacity-90"
              >
                Contact Us
              </a>
            </div>
  ...
  return (
    <>
      <li>
        <a
          href={NavLink}
          className="text-dark hover:text-primary flex py-2 text-base font-medium lg:ml-12 lg:inline-flex lg:text-white"
        >
          {children}
        </a>
      </li>
